...
| 名称                                                                                                  | 描述                                                     |
| :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------- |
| [GKD](https://github.com/gkd-kit/)                                                                    | 通过无障碍实现模拟点击，功能强大，指哪点哪，去他妈的广告 |
| [Via浏览器](https://viayoo.com/zh-cn/)                                                                | 简洁、流畅、功能强大的浏览器，支持去广告、安装脚本       |
| [venera](https://github.com/venera-app/venera)                                                        | 涩涩漫画，支持订阅哔咔、禁漫源                           |
| [LocalSend](https://github.com/localsend/localsend)                                                   | 局域网传输软件                                           |
| [Flix](https://flix.center/)                                                                          | 局域网传输工具，支持全平台                               |
| [文件闪传](https://www.xiaolifaa.com/)                                                                | 电脑浏览器查看手机文件，支持互传                         |
| [bitwarden](https://github.com/bitwarden/android)                                                     | 密码管理软件                                             |
| [shizuku](https://github.com/thedjchi/Shizuku)                                                        | 无root玩机                                               |
| [termux](https://github.com/termux/termux-app)                                                        | 终端模拟器                                               |
| [seal](https://github.com/JunkFood02/Seal)                                                            | 视频下载器，支持多个视频平台                             |
...
| [雹](https://github.com/aistra0528/Hail)                                                              | 冻结、停用、卸载手机软件，但在高版本安卓上作用有限       |
| [Salt Player](https://moriafly.com/)                                                                  | 简洁美观的本地音乐播放器                                 |
| [kazumi](https://github.com/Predidit/Kazumi)                                                          | 看番软件                                                 |
| [mihon](https://github.com/mihonapp/mihon)                                                            | 看漫画软件                                               |
| [纯纯看番](https://github.com/easybangumiorg/EasyBangumi)                                             | 看番软件                                                 |
| [贴吧 Lite](https://github.com/zzc10086/TiebaLite)                                                    | 第三方贴吧                                               |
| [tvbox](https://github.com/qist/tvbox)                                                                | 影视软件                                                 |
| [EasyBox](https://easybox.vip/)                                                                       | 影视软件                                                 |
...
| [阅读](https://github.com/gedoor/legado)                                                              | 知名看小说软件                                           |
| [Image Toolbox](https://github.com/T8RIN/ImageToolbox)                                                | 图像编辑软件                                             |
| [雪豹速清](http://www.icoolby.com/)                                                                   | 垃圾清理软件，大部分功能需购买会员才能使用               |
| [存储空间清理](http://apps.ktlshu.vip/)                                                               | 垃圾清理软件，大部分功能需购买会员才能使用               |
| [Droid-ify](https://github.com/Droid-ify/client)                                                      | 干净整洁的第三方F-Droid                                  |
| [Amarok](https://github.com/deltazefiro/Amarok-Hider)                                                 | 文件隐藏软件，搭配root获得最佳体验                       |
| [Soul Browser](https://play.google.com/store/apps/details?id=com.mycompany.app.soulbrowser)           | 自定义程度极高的浏览器                                   |
| [LibChecker](https://github.com/LibChecker/LibChecker)                                                | 应用依赖库查看器                                         |
| [Next Player](https://github.com/anilbeesetti/nextplayer)                                             | 界面简洁美观的视频播放器，支持本地和网络串流             |
| [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr)                                              | 自定义 Material You 颜色                                 |
| [NyaLoader](https://github.com/Jinsens/NyaLoader)                                                     | 多线程下载器，不支持磁力链接                             |
| [知乎++](https://github.com/zly2006/zhihu-plus-plus)                                                  | 第三方知乎，简洁去广告                                   |
| [Hydrogen](https://github.com/zhihulite/Hydrogen)                                                     | 第三方知乎，简洁去广告                                   |
| [XMSLEEP](https://github.com/Tosencen/XMSLEEP)                                                        | 白噪音播放应用                                           |
| [小萌GIF](https://github.com/tasy5kg/CuteGIF)                                                         | 视频转GIF                                                |
| [kdeconnect](https://kdeconnect.kde.org/download.html)                                                | 局域网跨设备同步剪切板、文件、通知等                     |
| [语燕输入法](https://github.com/gurecn/YuyanIme)                                                      | 开源的输入法                                             |
| [蜂蜜TV](https://github.com/FongMi/Release)                                                           | tvbox衍生版                                              |
| [Gopeed](https://github.com/GopeedLab/gopeed)                                                         | 下载工具                                                 |
| [AB Download Manager](https://github.com/amir1376/ab-download-manager)                                | 下载工具                                                 |
| [无障碍管理器](https://github.com/WuDi-ZhanShen/AccessibilityManager)                                 | 保活无障碍权限                                           |
| [Just Player](https://github.com/moneytoo/Player)                                                     | 本地视频播放器                                           |
| [Anx Reader](https://github.com/Anxcye/anx-reader)                                                    | 电子书阅读器                                             |
| [Stratum](https://github.com/stratumauth/app)                                                         | 免费开源的双重身份验证应用                               |
...
| [ContextMenuMgr](https://github.com/PLFJY/ContextMenuMgr)                              | Windows右键菜单管理工具具                                                     |
